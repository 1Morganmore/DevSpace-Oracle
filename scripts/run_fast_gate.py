...
FAST_NODE_IDS = [
    ...
    "tests/test_chatgpt_oracle_run.py::test_no_submission_preflight_checks_runtime_without_creating_run_state",
    "tests/test_chatgpt_oracle_run.py::test_preflight_reports_missing_profile_and_devspace_without_browser",
    "tests/test_chatgpt_oracle_run.py::test_preflight_and_live_run_share_endpoint_failure_without_oracle_launch",
    "tests/test_chatgpt_oracle_run.py::test_pro_live_submission_never_calls_devspace_readiness_adapters",
    "tests/test_chatgpt_oracle_run.py::test_windows_launch_uses_no_window_and_waits",
    "tests/test_chatgpt_oracle_run.py::test_windows_live_submission_requires_profile_seed_before_run_layout",
    ...
    "tests/test_chatgpt_oracle_compat.py::test_live_pill_refusals_fail_before_send",
    "tests/test_chatgpt_oracle_compat.py::test_live_pill_lost_before_send_fails_closed",
    "tests/test_chatgpt_oracle_compat.py::test_generic_exact_text_semantic_nodes_cannot_authorize_send",
    "tests/test_chatgpt_oracle_compat.py::test_only_visible_exact_devspace_token_inside_editor_can_authorize_send",
    "tests/test_chatgpt_oracle_compat.py::test_exact_app_suggestion_with_wrong_semantic_decorator_fails_before_send",
    "tests/test_chatgpt_devspace_compat.py::test_service_identity_normalizes_npx_bin_parent_path",
    "tests/test_chatgpt_devspace_compat.py::test_compatibility_inspection_requires_patched_exact_listener_without_writing",
    "tests/test_devspace_tailscale_setup.py::test_doctor_requires_exact_devspace_health_identity",
    "tests/test_chatgpt_oracle_diagnose.py",
    "tests/test_chatgpt_oracle_incident.py",
    "tests/test_chatgpt_oracle_profiles.py",
    "tests/test_global_gpt_browser_policy.py",
