...
sessions, and an optional Pro stage uses Oracle attachment-only. Each web stage
authors the next semantic mission while the host validates immutable hashes and
